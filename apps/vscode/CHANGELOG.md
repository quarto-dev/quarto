...
- Update to quarto cell background configuration to add the ability to use color theme option. The `quarto.cells.background` settings have changed names so you may need to update configuration. (<https://github.com/quarto-dev/quarto/pull/650>)
