...
import { buildTreeSitterAnnotation, locateCursor } from "./annotated-yaml.js";
...
import { initState, setInitializer } from "../yaml-validation/state.js";

import { guessChunkOptionsFormat } from "../guess-chunk-options-format.js";
import { asMappedString, MappedString, mappedString } from "../mapped-text.js";
import { lineColToIndex, lines } from "../text.js";
import { breakQuartoMd, QuartoMdCell } from "../break-quarto-md.js";
import { rangedLines } from "../ranged-text.js";
import {
  kLangCommentChars,
  partitionCellOptionsText,
} from "../partition-cell-options.js";

import {
  expandAliasesFrom,
  schemaAccepts,
  setSchemaDefinition,
} from "../yaml-validation/schema.js";

import { withValidator } from "../yaml-validation/validator-queue.js";

import { navigateSchemaByInstancePath as navigateSchema } from "../yaml-validation/schema-navigation.js";

import { resolveSchema } from "../yaml-validation/resolve.js";

import {
  schemaCompletions,
  walkSchema,
} from "../yaml-validation/schema-utils.js";

import { mappedIndexToLineCol } from "../mapped-text.js";

import { lineOffsets } from "../text.js";
...
import { getFormatAliases } from "../yaml-schema/format-aliases.js";
import { getFrontMatterSchema } from "../yaml-schema/front-matter.js";
import { getEngineOptionsSchema } from "../yaml-schema/chunk-metadata.js";
import {
  getExtensionConfigSchema,
  getProjectConfigSchema,
} from "../yaml-schema/project-config.js";
import {
  getYamlIntelligenceResource,
  setYamlIntelligenceResources,
} from "./resources.js";
import { loadDefaultSchemaDefinitions } from "../yaml-schema/definitions.js";
import { patchMarkdownDescriptions } from "./descriptions.js";
...
async function init(
  ...
  const ideInit = async () => {
    const resourceModule = (await import(
      "../../resources/yaml-intelligence-resources.json",
      { assert: { type: "json" } }
